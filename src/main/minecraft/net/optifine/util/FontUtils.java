...
public class FontUtils {
   ...
   public static void reloadFonts() {
      ...
      if (fontmanager != null) {
         fontmanager.reload(preparablereloadlistener$preparationbarrier, Config.getResourceManager(), InactiveProfiler.INSTANCE, InactiveProfiler.INSTANCE, executor, minecraft);
      }
   }
}

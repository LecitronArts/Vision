...
public class Lagometer {
   ...
   public static void updateLagometer() {
      ...
      if (mc.getDebugOverlay().renderDebug && (gameSettings.ofLagometer || mc.getDebugOverlay().renderFpsCharts)) {
         active = true;
   ...
   public static void showLagometer(GuiGraphics graphicsIn, int scaleFactor) {
      if (gameSettings != null) {
         if (gameSettings.ofLagometer || mc.getDebugOverlay().renderFpsCharts) {

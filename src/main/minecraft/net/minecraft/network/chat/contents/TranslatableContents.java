...
public class TranslatableContents implements ComponentContents {
   ...
   public static final MapCodec<TranslatableContents> CODEC = RecordCodecBuilder.mapCodec((p_311272_) -> p_311272_.group(Codec.STRING.fieldOf("translate").forGetter((p_309788_) -> p_309788_.key), Codec.STRING.optionalFieldOf("fallback").forGetter((p_310035_) -> Optional.ofNullable(p_310035_.fallback)), ExtraCodecs.strictOptionalField(ARG_CODEC.listOf(), "with").forGetter((p_309865_) -> adjustArgs(p_309865_.args))).apply(p_311272_, TranslatableContents::create));

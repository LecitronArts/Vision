...
public class BitmapProvider implements GlyphProvider {
   ...
   public static record Definition(ResourceLocation file, int height, int ascent, int[][] codepointGrid) implements GlyphProviderDefinition {
      ...
      public static final MapCodec<BitmapProvider.Definition> CODEC = ExtraCodecs.validate(RecordCodecBuilder.mapCodec((defIn) -> {
         return defIn.group(ResourceLocation.CODEC.fieldOf("file").forGetter(BitmapProvider.Definition::file), Codec.INT.optionalFieldOf("height", Integer.valueOf(8)).forGetter(BitmapProvider.Definition::height), Codec.INT.fieldOf("ascent").forGetter(BitmapProvider.Definition::ascent), CODEPOINT_GRID_CODEC.fieldOf("chars").forGetter(BitmapProvider.Definition::codepointGrid)).apply(defIn, BitmapProvider.Definition::new);
      ...
      private GlyphProvider load(ResourceManager p_286694_) throws IOException {
         ...
         try (InputStream inputstream = p_286694_.open(resourcelocation)) {
            ...
            CodepointMap<BitmapProvider.Glyph> codepointmap = new CodepointMap<>((p_285991_0_) -> {
               return new BitmapProvider.Glyph[p_285991_0_];
            }, (p_285954_0_) -> {
               return new BitmapProvider.Glyph[p_285954_0_][];
            });

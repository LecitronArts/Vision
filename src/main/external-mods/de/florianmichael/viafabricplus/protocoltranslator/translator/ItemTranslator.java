...
public class ItemTranslator {
    ...
    private static final int CREATIVE_INVENTORY_ACTION_ID = ConnectionProtocol.PLAY.codec(PacketFlow.SERVERBOUND).packetId(new ServerboundSetCreativeModeSlotPacket(0, ItemStack.EMPTY));
    ...
    public static ItemStack viaB1_8toMc(final Item item) {
        try {
            ...
            final ItemStack mcItem = new ItemStack(BuiltInRegistries.ITEM.byId(viaItem.identifier()));
            mcItem.setCount(viaItem.amount());
            mcItem.setDamageValue(viaItem.data());
            return mcItem;
        } catch (Throwable t) {

...
public class EntityPackets1_15 extends EntityRewriter<ClientboundPackets1_15, Protocol1_14_4To1_15> {
    ...
    protected void registerRewrites() {
        ...
        filter().type(EntityTypes1_15.WOLF).index(8).handler((event, meta) -> event.createExtraMeta(new Metadata(17/*WOLF_HEALTH*/, Types1_14.META_TYPES.floatType, event.meta().value())));
    }

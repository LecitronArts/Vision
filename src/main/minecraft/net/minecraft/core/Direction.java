...
public enum Direction implements StringRepresentable {
   ...
   public static final Direction[] BY_3D_DATA = Arrays.stream(VALUES).sorted(Comparator.comparingInt((p_235686_0_) -> {
      return p_235686_0_.data3d;
   })).toArray((p_235680_0_) -> {
      return new Direction[p_235680_0_];
   });
   private static final Direction[] BY_2D_DATA = Arrays.stream(VALUES).filter((p_235684_0_) -> {
      return p_235684_0_.getAxis().isHorizontal();
   }).sorted(Comparator.comparingInt((p_235682_0_) -> {
      return p_235682_0_.data2d;
   })).toArray((p_235676_0_) -> {
      return new Direction[p_235676_0_];
   });

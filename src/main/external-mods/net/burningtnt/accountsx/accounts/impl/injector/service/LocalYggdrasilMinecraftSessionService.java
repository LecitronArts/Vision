...
public class LocalYggdrasilMinecraftSessionService extends YggdrasilMinecraftSessionService {
    ...
    static {
        ...
        try {
            ...
            AccountsX.INSTANCE.LOGGER.error("Cannot get com.mojang.authlib.yggdrasil.YggdrasilMinecraftSessionService::getPropertySignatureState handle.", e);
            handle = null;
        }
    ...
    public MinecraftProfileTextures unpackTextures(Property packedTextures) {
        ...
        try {
            ...
            AccountsX.INSTANCE.LOGGER.error("Could not decode textures payload", e);

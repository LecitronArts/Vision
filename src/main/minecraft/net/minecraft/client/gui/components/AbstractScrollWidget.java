...
public abstract class AbstractScrollWidget extends AbstractWidget implements Renderable, GuiEventListener {
   ...
   private void renderScrollBar(GuiGraphics pGuiGraphics) {
      scrollAmount = (scrollAmount - targetScrollY) / Math.pow(2, Minecraft.getInstance().getDeltaFrameTime()) + targetScrollY;
      if (scrollAmount < targetScrollY + 0.1 && scrollAmount > targetScrollY - 0.1)
         scrollAmount = targetScrollY;
      int i = this.getScrollBarHeight();

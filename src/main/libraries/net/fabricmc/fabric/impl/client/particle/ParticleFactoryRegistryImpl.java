...
public final class ParticleFactoryRegistryImpl implements ParticleFactoryRegistry {
	...
	static class DirectParticleFactoryRegistry implements ParticleFactoryRegistry {
		...
		@Override
		public <T extends ParticleOptions> void register(net.minecraft.core.particles.ParticleType<T> type, ParticleProvider<T> factory) {
			particleManager.providers.put(BuiltInRegistries.PARTICLE_TYPE.getKey(type), factory);
		}

		@Override
		public <T extends ParticleOptions> void register(net.minecraft.core.particles.ParticleType<T> type, PendingParticleFactory<T> constructor) {
			ParticleEngine.MutableSpriteSet delegate = new ParticleEngine.MutableSpriteSet();
			FabricSpriteProvider fabricSpriteProvider = new FabricSpriteProviderImpl(particleManager, delegate);
			particleManager.spriteSets.put(BuiltInRegistries.PARTICLE_TYPE.getKey(type), delegate);

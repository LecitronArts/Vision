   ...
   public void render(T pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, pEntity, this, pPartialTicks, pPoseStack, pBuffer, pPackedLight)) {
         ...
         if (pEntity.hasPose(Pose.SLEEPING)) {
            ...
            if (direction != null) {
               float f8 = pEntity.getEyeHeight(Pose.STANDING) - 0.1F;
         ...
         this.model.prepareMobModel(pEntity, f4, f9, pPartialTicks);
         this.model.setupAnim(pEntity, f4, f9, f7, f2, f6);
         if (CustomEntityModels.isActive()) {
            this.renderLimbSwing = f4;
         ...
         if (rendertype != null) {
            ...
            float f5 = this.getWhiteOverlayProgress(pEntity, pPartialTicks);
            if (flag) {
               ...
               if (f5 > 0.0F) {
                  Shaders.setEntityColor(f5, f5, f5, 0.5F);
               }
            }

            int i = getOverlayCoords(pEntity, f5);
         ...
         if (!pEntity.isSpectator()) {
            for(RenderLayer<T, M> renderlayer : this.layers) {
               ...
               renderlayer.render(pPoseStack, pBuffer, pPackedLight, pEntity, f4, f9, pPartialTicks, f7, f2, f6);

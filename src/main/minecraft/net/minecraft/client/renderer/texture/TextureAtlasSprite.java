...
public class TextureAtlasSprite {
   ...
   private TextureAtlasSprite(TextureAtlasSprite parent) {
      ...
      this.contents = new SpriteContents(spritecontents.name(), new FrameSize(spritecontents.width, spritecontents.height), spritecontents.getOriginalImage(), spritecontents.metadata());
   ...
   public TextureAtlasSprite makeSpriteShaders(ShadersTextureType type, int colDef, SpriteContents.AnimatedTexture parentAnimatedTexture) {
      ...
      if (textureatlassprite == null) {
         ...
         SpriteContents spritecontents = new SpriteContents(resourcelocation, new FrameSize(this.getWidth(), this.getHeight()), nativeimage2, ResourceMetadata.EMPTY);

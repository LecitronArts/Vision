...
public record NoiseGeneratorSettings(NoiseSettings noiseSettings, BlockState defaultBlock, BlockState defaultFluid, NoiseRouter noiseRouter, SurfaceRules.RuleSource surfaceRule, List<Climate.ParameterPoint> spawnTarget, int seaLevel, boolean disableMobGeneration, boolean aquifersEnabled, boolean oreVeinsEnabled, boolean useLegacyRandomSource) {
   ...
   private static NoiseGeneratorSettings end(BootstapContext<?> pContext) {
   ...
   private static NoiseGeneratorSettings nether(BootstapContext<?> pContext) {
   ...
   private static NoiseGeneratorSettings overworld(BootstapContext<?> pContext, boolean pAmplified, boolean pLarge) {
   ...
   private static NoiseGeneratorSettings caves(BootstapContext<?> pContext) {
   ...
   private static NoiseGeneratorSettings floatingIslands(BootstapContext<?> pContex) {

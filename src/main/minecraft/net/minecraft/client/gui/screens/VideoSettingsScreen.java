...
public class VideoSettingsScreen extends GuiScreenOF {
   ...
   private void checkFabulousWarning() {
      if (this.gpuWarnlistManager.isShowingWarning()) {
         ...
         this.minecraft.setScreen(new UnsupportedGraphicsWarningScreen(WARNING_TITLE, list, ImmutableList.of(new UnsupportedGraphicsWarningScreen.ButtonOption(BUTTON_ACCEPT, (btn) -> {
   ...
   public void onClose() {
      minecraft.setScreen(parentGuiScreen);
   }

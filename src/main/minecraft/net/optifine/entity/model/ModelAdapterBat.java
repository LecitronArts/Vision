...
public class ModelAdapterBat extends ModelAdapter {
   ...
   public ModelPart getModelRenderer(Model model, String modelPart) {
      if (!(model instanceof BatModel batmodel)) {
         ...
         return modelPart.equals("feet") ? batmodel.root().getChildModelDeep("feet") : null;
      }
   }

   public String[] getModelRendererNames() {
      return new String[]{"head", "body", "right_wing", "left_wing", "outer_right_wing", "outer_left_wing", "feet"};
   }

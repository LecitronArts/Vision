...
public class RenderEnv {
   ...
   private SectionBufferBuilderPack regionRenderCacheBuilder = null;
   ...
   public SectionBufferBuilderPack getRegionRenderCacheBuilder() {
      return this.regionRenderCacheBuilder;
   }

   public void setRegionRenderCacheBuilder(SectionBufferBuilderPack regionRenderCacheBuilder) {
